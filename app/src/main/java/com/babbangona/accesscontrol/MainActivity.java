...
try{
        ...
        try{
            ...
            try{  Cursor cursor = managedQuery(students, null, null, null, "_id DESC");
    ...
    public void IdSignIn(View view) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(username.getText().toString().matches("")) username.setError("Enter last 5 digits of your staff id");
                else if(password.getText().toString().matches("")) password.setError("Enter your password");
                else if(username.getText().toString().length() != 5) username.setError("Ensure you enter last 5 digits of your staff id");
                else{
